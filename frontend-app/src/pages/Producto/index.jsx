...
class MovieIndexPage extends React.Component {
    ...
    createMovie = () => {
        this.props.navigate("/productos/create/");
    }
    ...
    render = () => {
      ...
      {/*  <form role="search" method="get" class="search-form" action="">
              ...
              <button type="submit" class="search-submit"><svg class="search"><use xlinkHref="#search"></use></svg></button>
            </form>
                  ...
                  <div class="product-card position-relative">
                    ...
                    <div class="cart-concern position-absolute">
                      <div class="cart-button d-flex">
                        <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
                      </div>
                    </div>
